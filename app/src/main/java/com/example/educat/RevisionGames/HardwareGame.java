...
public class HardwareGame extends AppCompatActivity implements View.OnClickListener {
    ...
    // Actual images
    int randomImage, romImage, cpuImage, gpuImage, hardriveImage, solidImage, randomImage1, romImage1, cpuImage1, gpuImage1, hardriveImage1, solidImage1;
    ...
    private void doStuff(ImageView iv, int card) {
        ...
        switch (cards[card]) {
            case 101:
                iv.setImageResource(randomImage);
                break;
            case 102:
                iv.setImageResource(romImage);
                break;
            case 103:
                iv.setImageResource(cpuImage);
                break;
            case 104:
                iv.setImageResource(gpuImage);
                break;
            case 105:
                iv.setImageResource(hardriveImage);
                break;
            case 106:
                iv.setImageResource(solidImage);
                break;
            case 201:
                iv.setImageResource(randomImage1);
                break;
            case 202:
                iv.setImageResource(romImage1);
                break;
            case 203:
                iv.setImageResource(cpuImage1);
                break;
            case 204:
                iv.setImageResource(gpuImage1);
                break;
            case 205:
                iv.setImageResource(hardriveImage1);
                break;
            case 206:
                iv.setImageResource(solidImage1);
                break;
        }
    ...
    private void frontOfCardsResources() {
        randomImage = R.drawable.random;
        romImage = R.drawable.rom;
        cpuImage = R.drawable.cpu;
        gpuImage = R.drawable.gpu;
        hardriveImage = R.drawable.hardrive;
        solidImage = R.drawable.solid;
        randomImage1 = R.drawable.ram1;
        romImage1 = R.drawable.rom1;
        cpuImage1 = R.drawable.cpu1;
        gpuImage1 = R.drawable.gpu1;
        hardriveImage1 = R.drawable.hardrive1;
        solidImage1 = R.drawable.solid1;
    }
}
