...
public class NotesDatabase extends SQLiteOpenHelper
{
    ...
    private static final String DATABASE_NAME = "Educat_notes";
    private static final String DATABASE_TABLE = "Eductatable";
    ...
    {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor cursor = db.query(DATABASE_TABLE,new String[]{KEY_ID,KEY_TITLE,KEY_CONTENT,KEY_TIME},KEY_ID+"=?",
